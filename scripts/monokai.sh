...
main()
{
  ...
  # Window option
  if $show_powerline; then
    tmux set-window-option -g window-status-current-format "#[fg=${dark_gray},bg=${white}]${left_sep}#[fg=${black},bg=${white}] #I #W${current_flags} #[fg=${white},bg=${dark_gray}]${left_sep}"
  else
